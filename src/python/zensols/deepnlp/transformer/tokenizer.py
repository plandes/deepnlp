...
from . import (
    TransformerError, TokenizedFeatureDocument,
    WordPiece, WordPieceToken, WordPieceSentence, WordPieceDocument
)
...
class TransformerDocumentTokenizer(PersistableContainer):
    ...
    def to_word_piece_document(self, tdoc: TokenizedFeatureDocument,
                               fdoc: FeatureDocument) -> WordPieceDocument:
